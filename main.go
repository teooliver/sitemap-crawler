...
// Interact with website as a human would do.
// Select a diferent userAgent on every request so we don't endup
// overloding the website and/or get blacklisted
...
// Capital letter means the function is exported and available to the packadge, else
...
func main() {
	p := DefaultParser{}
	results := ScrapeSitemap("<SITE-MAP-URL", p, 10)
